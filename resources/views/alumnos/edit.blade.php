                        ...
                        <div class="form-group">
                            ...
                            <select name="colegiatura_id" id="colegiatura_id" class="form-control">
                                ...
                                @foreach($colegiaturas as $c)
                                    <option value="{{ $c->id }}" {{ old('colegiatura_id', $alumno->colegiatura_id) == $c->id ? 'selected' : '' }} data-monto="{{ $c->monto }}">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="colegiatura" id="colegiatura" class="form-control" value="{{ old('colegiatura', $alumno->colegiatura) }}" placeholder="0.00">
