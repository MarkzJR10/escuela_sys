...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menus = [
            ...
            ['text' => 'Profesores', 'url' => 'profesores', 'icon' => 'fas fa-fw fa-user-tie', 'roles' => ['administrador', 'coordinador']],
            ['text' => 'Grados y Grupos', 'url' => 'grado_grupos', 'icon' => 'fas fa-fw fa-chalkboard-teacher', 'roles' => ['administrador', 'coordinador']],
            ['text' => 'Materias', 'url' => 'materias', 'icon' => 'fas fa-fw fa-book', 'roles' => ['administrador', 'coordinador']],
            ['text' => 'Calificaciones', 'url' => 'calificaciones', 'icon' => 'fas fa-fw fa-star', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Control de Periodos', 'url' => 'periodos', 'icon' => 'fas fa-fw fa-clock', 'roles' => ['administrador']],
            ['text' => 'Asistencia', 'url' => 'asistencias', 'icon' => 'fas fa-fw fa-clipboard-check', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Padres', 'url' => 'padres', 'icon' => 'fas fa-fw fa-users-cog', 'roles' => ['administrador']],
            ...
            ['text' => 'Configuración General', 'url' => 'configuraciones', 'icon' => 'fas fa-fw fa-sliders-h', 'roles' => ['administrador']],
            ...
            ['text' => 'Conducta (Capturar)', 'url' => 'reportes_conducta/seleccionar', 'icon' => 'fas fa-fw fa-plus-circle', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Conducta (Reportes del Día)', 'url' => 'reportes_conducta', 'icon' => 'fas fa-fw fa-calendar-day', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Conducta (Pendientes)', 'url' => 'reportes_conducta/pendientes', 'icon' => 'fas fa-fw fa-envelope', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Conducta Destacada', 'url' => 'conducta-destacada', 'icon' => 'fas fa-fw fa-star-half-alt', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Reportes de Tareas', 'url' => 'reportes_tareas', 'icon' => 'fas fa-fw fa-tasks', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Boletas', 'url' => 'boletas', 'icon' => 'fas fa-fw fa-file-pdf', 'roles' => ['administrador', 'coordinador', 'maestro']],
            ['text' => 'Cuadro de Honor', 'url' => 'cuadro-honor', 'icon' => 'fas fa-fw fa-trophy', 'roles' => ['administrador', 'coordinador', 'maestro']],
